...
class Author(models.Model):
    ...
    last_name = models.CharField(max_length=100,help_text="Введите фамилию автора",verbose_name="Фамаилия автора")
...
class Book(models.Model):
    ...
    isbn = models.CharField(max_length=13,help_text="Должно содержать 13 символов",verbose_name="ISBN нкниги")
...
class BookInstance(models.Model):
    ...
    imprint = models.CharField(max_length=20,help_text="Введите изательство и год выпуска",verbose_name="Издательство")
